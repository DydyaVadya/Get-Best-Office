                            ...
                            <ul>
                                <li>
                                    <label for="dsp">
                                        ...
                                        <div>
                                            <input type="checkbox" name="ZshkafCover[]" id="dsp"
                                                   value="ламинированное ДСП, ЛДСП"> Ламинированное ДСП, ЛДСП
                                        </div>
                                    </label>
                                </li>
                                <li>
                                ...
                                <li>
                                    <label for="peskostrui">
                                        <div class="coverImg peskostrui">
                                            <a href="#" class="vopros toolTip"
                                               title="Использование пескоструйных рисунков позволяет сделать из обычного шкафа-купе настоящую изюминку для Вашего интерьера. Рисунки на зеркале создаются при помощи специальной технологии, которая позволяет часть поверхности зеркала сделать матовой, а часть оставить зеркальной. Таким образом, можно создавать самые разные рисунки. Вы можете выбрать рисунок из каталога фабрики производителя или разработать специально под Ваш интерьер. ">
                                                ?
                                            </a>
                                        </div>
                                        <div>
